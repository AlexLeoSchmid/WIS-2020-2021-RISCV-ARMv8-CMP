...
\label{ref:conclusion}
	...
	by implementing the small base \gls{ISA} and only implementing additional extensions as needed.
	...
	This shows that the RISC-V \gls{ISA} is still in its infancy, nevertheless there has already been significant interest in RISC-V.
