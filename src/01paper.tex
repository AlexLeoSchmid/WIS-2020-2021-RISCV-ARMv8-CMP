...
that can run on that \gls{CPU}. This is especially important in consumer desktop and mobile devices where a large variety of software is to be executed.
	...
	Additional to the explained load and store instructions both architectures have many other instructions, viewed are both times the basic 32-bit instruction sets (RV32I for RISC-V and A32 for ARMv8).
