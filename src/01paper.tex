...
\label{ref:background}
	...
	\subsection{ARM}
	ARM is one of the most common \gls{RISC} based \glspl{ISA}. 1990 the ARM Ltd. like it is known now, started with the name xxx owned by Apple, .... In year xxxx ARM was renamed to ARM Ltd. and its completely independed. Now ARM is one of the most licensed an most well known manufacturer of \glspl{ISA}. Especially in mobile devices ARM is very common not only because of the better battery handling compared to \gls{CISC} \glspl{ISA}.
